...
**Occurrences:** dinner_intent (12/12), dummy_intent(12/12), dean_intent(12/12), lecture_intent(12/12)
...
**Occurrences:** dinner_intent (sharing, maintenance), dean_intent(survive, help, maintenance), lecture_intent(hand_eye_coordination, risk_reward, maintenance)
...
**Occurrences:** dinner_intent (food, friend; satiation/write, though note the satiation label here is *conditional*, see label_rule), dean_intent (yourself, help, harm; composure/write, tension/read_only), lecture_intent(concentration/write; e1)
...
**Occurrences:** dinner_intent(r(1),satiation,write,good,r(1)), lecture_intent(r(1),concentration,write,good,r(1))  
...
**Occurrences:** dinner_intent (require/narrative_gating), dean_intent (forbid/game_win) x2, lecture_intent(require/game_loss) both lecture & dinner appeared with mode_change_cap  

## Pattern: mode_change_cap  
**Description:** caps mode_change actions (of any mode) at <low> − 1.  
**Shape:** `:- <low> {action(mode_change(N))}.`  
**Varies:** low  
**Occurrences:** dinner_intent (2), lecture_intent (2), both appeared together with mode_change_constraint  
...
**Occurrences:** lecture_intent(orbit_the_cursor, repeled_from_cursor), paired with forbidden_scheme_outcome
...
**Occurrences** lecture_intent(orbit_the_cursor, repeled_from_cursor), paired with control_scheme_constraint
...
**Occurrences** lecture_intent(increase/r(1))
