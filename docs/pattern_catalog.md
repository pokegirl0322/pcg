...
**Varies:** entity   
**Occurrences:** lecture_intent_clear (e(1))  
...
**Occurrences:** lecture_intent(orbit_the_cursor, repeled_from_cursor), lecture_intent_attract (orbit_the_cursor, repeled_from_cursor), lecture_intent_avoid (orbit_the_cursor, repeled_from_cursor), lecture_intent_clear (orbit_the_cursor, repeled_from_cursor) all paired with forbidden_scheme_outcome  
...
**Occurrences** lecture_intent(orbit_the_cursor, repeled_from_cursor), lecture_intent_attract (orbit_the_cursor, repeled_from_cursor), lecture_intent_avoid (orbit_the_cursor, repeled_from_cursor), lecture_intent_clear (orbit_the_cursor, repeled_from_cursor) all paired with control_scheme_constraint  
...
**Occurrences** lecture_intent(increase/r(1)), lecture_intent_attract(increase/r(1)), lecture_intent_avoid (increase/r(1)), lecture_intent_clear (increase/r(1))   
...
**Varies:** direction, resource  
**Occurrences:** lecture_intent_attract(increase/r(1)), lecture_intent_avoid (increase/r(1)), lecture_intent_clear (increase/r(1))    
